# Deployment Guide — IT-Stack FREEIPA
...
- DNS entry: freeipa.it-stack.lab → lab-id1
...
```sql
CREATE USER freeipa_user WITH PASSWORD 'CHANGE_ME';
CREATE DATABASE freeipa_db OWNER freeipa_user;
```
...
- Client ID: $Module
- Valid redirect URI: https://freeipa.it-stack.lab/*
- Web origins: https://freeipa.it-stack.lab
...
```bash
curl -I https://freeipa.it-stack.lab/health
```

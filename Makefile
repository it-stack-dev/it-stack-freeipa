# Makefile — IT-Stack FREEIPA (Module 01)
...
build: ## Build Docker image
	docker build -t it-stack/freeipa:latest .
...
test-lab-01: ## Lab 01 — Standalone
	@bash tests/labs/test-lab-01-01.sh

test-lab-02: ## Lab 02 — External Dependencies
	@bash tests/labs/test-lab-01-02.sh

test-lab-03: ## Lab 03 — Advanced Features
	@bash tests/labs/test-lab-01-03.sh
...
test-lab-06: ## Lab 06 — Production Deployment
	@bash tests/labs/test-lab-01-06.sh

deploy: ## Deploy to target server (lab-id1)
	ansible-playbook -i ansible/inventory.yml ansible/playbooks/deploy-freeipa.yml
